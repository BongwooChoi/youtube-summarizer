...
#!pip install ffmpeg streamlit yt-dlp openai-whisper openai langchain langchain_community
...
# 제목과 부제목
st.title("바쁘다 바빠 현대사회")
st.subheader("YouTube 영상 언제 다 보나요? 핵심 내용만 요약해서 알려 드립니다.")
